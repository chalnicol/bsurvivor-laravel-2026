...
import DropdownSelectButton from '@/components/dropdownSelectButtons';
      ...
      {type === 'date' ? (
        <>
          <DropdownSelectButton
            ...
            renderedLabel={(value) =>
              value !== null && value !== undefined ? months[value].name : ''
            }
            value={month}
            onChange={setMonth}
          ...
          <DropdownSelectButton
            ...
            position={
              optionsPosition === 'bottom' ? 'bottom-right' : 'top-right'
            }
            disabled={disabled}
            color={color}
          />
